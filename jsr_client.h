...
static zval _php_jsr_response_error(zval *response_tmp, zval *error, long code, char *message, jsr_payload_id *payload_id);
...
static
inline php_jsr_reuqest_object *_php_jsr_request_fetch_object(zend_object *obj) {
  return (php_jsr_reuqest_object *)((char *)obj - XtOffsetOf(php_jsr_reuqest_object, zo));
}

static zend_object *_php_jsr_request_object_new(zend_class_entry *class_type);
static void _php_jsr_request_object_free_storage(zend_object *object);
